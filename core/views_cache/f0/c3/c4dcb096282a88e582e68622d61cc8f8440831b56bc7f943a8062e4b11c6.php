...
class __TwigTemplate_f0c3c4dcb096282a88e582e68622d61cc8f8440831b56bc7f943a8062e4b11c6 extends Twig_Template
{
...
<p class='center'>
  <a href='";
        // line 36
        echo twig_escape_filter($this->env, $this->env->getExtension('slim')->site("/download"), "html", null, true);
        echo "?itinerary=";
        echo twig_escape_filter($this->env, $this->getAttribute((isset($context["itinerary"]) ? $context["itinerary"] : $this->getContext($context, "itinerary")), "id", array()), "html", null, true);
        echo "' title='";
        echo gettext("Start");
